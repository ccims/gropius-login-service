...
import { CheckAccessTokenGuard } from "src/util/guards/CheckAccessTokenGuard";
 ...
 */
@Injectable()
export class CheckAuthAccessTokenGuard extends CheckAccessTokenGuard {
    constructor(tokenService: TokenService, reflector: Reflector, backendUserService: BackendUserService) {
        super(tokenService, reflector, backendUserService, TokenScope.AUTH);
    }
}
